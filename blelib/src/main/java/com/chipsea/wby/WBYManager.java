...
public class WBYManager implements BleManager<WBYManagerCallbacks> {
     ...
     * ------------------------------ UUID -----------------------------------------------------------------------------
     */
    /** NON LOCKED SERVICE and CHARACTERISTIC **/
    ...
    /** LOCKED SERVICE and CHARACTERISTIC **/
    //private static final UUID LOCKED_SERVICE_UUID = UUID.fromString("0000181b-0000-1000-8000-00805f9b34fb");

    //private static final UUID LOCKED_READ_INDICATE_CHARACTERISTIC_UUID = UUID.fromString("0000fa9c-0000-1000-8000-00805f9b34fb");

    /** LOCKED SERVICE and CHARACTERISTIC **/
    private static final UUID LOCKED_SERVICE_UUID = UUID.fromString("0000fff0-0000-1000-8000-00805f9b34fb");

    private static final UUID LOCKED_READ_INDICATE_CHARACTERISTIC_UUID = UUID.fromString("0000fff1-0000-1000-8000-00805f9b34fb");
...
//            L.d(TAG, "getVersion");
//            startGetVersionTimer(); //1、Start version timer
//        }
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                /**
                 * todo Enable can only write one feature at the same time
                 */

                /**
                 * Non-locking data enable
                 */
...
//                }
    ...
    /**
     * Determine whether there is a Chipsea UUID
     *
     * @return
     */
    ...
    /**
     * Write value to the feature value of aicare with write attribute
     *
     * @param b
     */
    ...
    /**
     * Get related information timed out
     */
    ...
    /**
     * Process the data passed by ble
     *
     * @param b
     */
    ...
    /**
     * Enable notifications for a given feature
     */
        ...
        if (service != null) {
            ...
            if (characteristic != null) {
                ...
                if (success) {
                    ...
                    // source: http://stackoverflow.com/questions/38045294/oncharacteristicchanged-not-called-with-ble
